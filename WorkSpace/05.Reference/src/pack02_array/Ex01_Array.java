...
public class Ex01_Array {
	public static void main(String[] args) {
		...
		//저장 처리하는 "객체" > 한 번 만든 크기는 다시 바꾸는 게 불편
		//형태 dataType[] name = new dataType[size];
		// 	  데이터타입[] 배열이름 = new 데이터타입[크기];
		
		//아직 스캐너나 별도의 처리로 점수를 입력하지 않은 변수 5개. 준비만 함
		int score1 = 0, score2 = 0, score3=0, score4=0, score5=0;
		//score1~5까지의 합: score1+2+3+...5 = 합
		...
		//[I@515f550a > 힙 영역의 주소(메모리) 값x
		scoreArray[0] = 10;//배열에 데이터 타입이 주어졌으면 해당하는 타입의 변수라고 생각
		System.out.println("scoreArray[0] 값: " + scoreArray[0]);
		
		//배열의 모든 인덱스에 10~50까지를 할당하고 출력해 보기
		scoreArray[1] = 20; //할당
		scoreArray[2] = 30;
		scoreArray[3] = 40;
		scoreArray[4] = 50;
		...
		//배열의 크기가 100이라면? > 반복문
		//반복문으로 scoreArray의 값을 모두 출력해 보기
